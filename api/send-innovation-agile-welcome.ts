// api/send-innovation-agile-welcome.ts
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    const welcomeEmailData = {
      ...
      to: [email],
      reply_to: REPLY_TO,
      subject: `${firstName}, votre guide "Innovation Agile" est prêt`,
      html: `
<!DOCTYPE html>
<html lang="fr">
<head>
  ...
  <title>MANA • Innovation Agile</title>
  <style>
    ...
    <tr>
      <td align="center">
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 16px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="background:linear-gradient(135deg, #0c3d5e 0%, #3b82f6 50%, #0c3d5e 100%);padding:40px 30px;text-align:center;">
          ...
          <tr>
            <td style="padding:40px 30px;">
              ...
              <p style="color:#475569;margin:0 0 20px 0;font-size:16px;line-height:1.6;">
                Votre guide <strong>"Innovation Agile : des principes aux résultats"</strong> est prêt à télécharger.
              </p>
              ...
              <div style="background:linear-gradient(135deg, #eff6ff 0%, #dbeafe 100%);border:1px solid #bfdbfe;border-radius:12px;padding:24px;margin:24px 0;">
                ...
                <ul style="color:#1e40af;margin:0;padding-left:20px;font-size:15px;line-height:1.7;">
                  <li><strong>Scrum</strong> — Cadre itératif pour équipes produits</li>
                  <li><strong>SAFe</strong> — Agilité à l'échelle de l'entreprise</li>
                  <li><strong>Kanban</strong> — Gestion du flux tiré et visualisé</li>
                  <li><strong>Scrumban</strong> — Hybride Scrum × Kanban</li>
                </ul>
              </div>
              ...
              <div style="background:linear-gradient(135deg, #f0fdf4 0%, #ecfdf5 100%);border:1px solid #bbf7d0;border-radius:12px;padding:24px;margin:24px 0;">
                ...
                <ul style="color:#166534;margin:0;padding-left:20px;font-size:15px;line-height:1.7;">
                  <li>Évaluer la maturité agile de vos équipes</li>
                  <li>Choisir le cadre adapté à votre échelle</li>
                  <li>Lancer une première itération et mesurer</li>
                </ul>
              </div>

              <div style="margin:32px 0 24px 0;">
                <p style="color:#475569;margin:0;font-size:15px;line-height:1.6;">
                  Envie d'accélérer votre transformation agile ? Notre équipe peut vous accompagner dans cette démarche.
                </p>
              </div>
...
Votre guide "Innovation Agile : des principes aux résultats" est prêt.

Contenu clé :
- Scrum — Cadre itératif pour équipes produits
- SAFe — Agilité à l'échelle de l'entreprise
- Kanban — Gestion du flux tiré et visualisé
- Scrumban — Hybride Scrum × Kanban

Prochaines étapes :
- Évaluer la maturité agile de vos équipes
- Choisir le cadre adapté à votre échelle
- Lancer une première itération et mesurer
...
Si vous ne souhaitez plus recevoir nos emails, cliquez ici.
    ...
    console.error('❌ Erreur send-innovation-agile-welcome:', error);
