...
export default function VisionMissionRaisonDetreValeurs() {
  ...
  formatList={['Masterclass', 'Atelier collectif', 'Format hybride', 'Séminaire']}
      ...
      objectives={[
        ...
        "Créer un alignement narratif pour renforcer l’engagement et la performance.",
      ]}
      ...
      modules={[
        ...
        { title: "Cartographie stratégique", desc: "Relier vision/mission/valeurs aux parties prenantes et aux choix stratégiques de l’organisation." },
        { title: "Atelier raison d’être", desc: "Formulation, test de robustesse et critères d’authenticité de la raison d’être." },
        { title: "Traduction en valeurs", desc: "Choix resserré, comportements associés, rituels d’appropriation pour engager les parties prenantes internes et externes." },
        { title: "Narratif stratégique", desc: "Transformer vision, mission et raison d’être en récit engageant pour la performance du collectif." },
      ...
      useCases={[
        ...
        "Utiliser les pôles identitaires comme source d’énergie créatrice et mobilisatrice.",
      ]}
