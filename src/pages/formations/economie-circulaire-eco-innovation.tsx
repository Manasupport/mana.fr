...
export default function EconomieCirculaireEcoInnovation() {
  return (
    <FormationLayout
      ...
      pills={[
        { icon: LineChart, label: "Modèles d’affaires durables" },
      ...
      // Contenu & déroulé
      modules={[
        { title: "Panorama introductif", desc: "Définitions, cadres académiques et institutionnels, champs d’application de la circularité." },
        { title: "Écoconception & cycle de vie", desc: "ACV (ISO 14040/14044), méthode PEF (16 indicateurs), Roue de Brezet." },
        { title: "Atelier pratique", desc: "Modéliser le cycle de vie d’un produit/service et prioriser les leviers d’écoconception." },
        { title: "Éco-innovation", desc: "Bouclage déchets-matières, éco-technologies sobres, éco-management." },
        { title: "Circularité faible vs forte", desc: "Impacts et choix de conception/organisation pour changer d’échelle et repenser les modèles d’affaires." },
